...
/**
 * ContemporaryTemplate (formerly Traditional)
 * Timeline-style layout with strong section labels.
 */
            ...
            <div className={`px-10 py-8 ${editMode ? 'pl-16' : ''}`}>
                ...
                <div className="grid grid-cols-[135px_22px_1fr] gap-x-1 items-start">
                    ...
                    <div className="flex items-start gap-4 min-w-0">
                        <div className="w-10 h-10 rounded-full border-2 text-slate-700 flex items-center justify-center font-semibold text-sm" style={{ borderColor: 'var(--tv-accent-dark)' }}>
                            {initials}
                        </div>
                        <div className="min-w-0">
                            <EditableText
                                ...
                                editMode={editMode}
                                className="text-3xl font-light leading-tight text-[color:var(--tv-accent)]"
                                as="div"
                            />
                ...
                <div className="mt-8">
                    <div className="relative">
                        ...
                        <div
                            ...
                            style={{ left: "calc(135px + 4px + 11px)", backgroundColor: 'var(--tv-accent-40)' }}
                        />
                                        ...
                                        {rows.map((row) => (
                                            <EditableSection key={row.key} id={row.key} editMode={editMode} sectionTitle={row.label.replace('\n', ' ')}>
                                                <div className="grid grid-cols-[135px_22px_1fr] gap-x-1">
                                                    <div className="pt-1 text-[11px] font-bold tracking-[0.18em] whitespace-pre-line" style={{ color: 'var(--tv-accent)' }}>
                                                        {typeof (row as any).customIndex === 'number' ? (
                                                            <EditableText
                                                                ...
                                                                editMode={editMode}
                                                                className="text-[11px] font-bold tracking-[0.18em] uppercase text-[color:var(--tv-accent)]"
                                                                as="div"
                                                            />
                                                        ) : (
                                                            <EditableText
                                                    ...
                                                    <div className="pt-2 flex justify-center">
                                                        <span className="relative z-10 w-2.5 h-2.5 rounded-full bg-white border-2" style={{ borderColor: 'var(--tv-accent-dark)' }} />
                                                    </div>
                                                    <div>{row.content}</div>
                                                </div>
                                            </EditableSection>
                ...
                {undoState ? (
                    <div className="fixed bottom-4 left-4 z-[9999] rounded-xl border border-gray-200 bg-white shadow-lg px-4 py-3 flex items-center gap-3">
                        ...
                        <button
                            type="button"
                            onClick={handleUndo}
                            className="text-sm font-semibold text-[color:var(--tv-primary)] hover:text-[color:var(--tv-primary-dark)]"
                        >
                            Undo
                        </button>
                    </div>
