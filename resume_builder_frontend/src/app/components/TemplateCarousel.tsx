...
import modernImage from '../../imports/modern.jpg';
import classicImage from '../../imports/classic.jpg';
import creativeImage from '../../imports/creative.jpg';
import boldProfessionalImage from '../../imports/BoldProfessional.jpg';
import contemporaryImage from '../../imports/traditional.jpg';
import executiveImage from '../../imports/executive.jpg';
import stylishImage from '../../imports/stylish.jpg';
import professionalImage from '../../imports/professional-1.jpg';

const templates: { id: ResumeTemplate; name: string; image: string }[] = [
  { id: 'modern', name: 'Modern', image: modernImage },
  { id: 'classic', name: 'Classic', image: classicImage },
  { id: 'creative', name: 'Creative', image: creativeImage },
  { id: 'boldprofessional', name: 'Bold Professional', image: boldProfessionalImage },
  { id: 'contemporary', name: 'Contemporary', image: contemporaryImage },
  { id: 'executive', name: 'Executive', image: executiveImage },
  { id: 'stylish', name: 'Stylish', image: stylishImage },
  { id: 'professional', name: 'Professional', image: professionalImage },
];
                ...
                >
                  <div
                    className={`bg-white rounded-lg shadow-xl overflow-hidden transition-all ${
                      isSelected ? 'ring-4 ring-blue-500' : 'ring-2 ring-gray-200 hover:ring-blue-300'
                    }`}
                  >
